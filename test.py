...
def build_graph(reader,
  ...
  logits_aux_0, train_v2 = model.create_logits_model(
      aux_fc_batch_0, 60, scope="auxlogs", is_training=False, reuse=None)
  # (21504,) -> (60,)
  aux_fc_batch_1 = tf.placeholder(tf.float32, (None, 21504))
  logits_aux_1, train_v3 = model.create_logits_model(
      aux_fc_batch_1, 60, scope="auxlogs", is_training=False, reuse=True)
...
def evaluation_loop(predictions, labels, loss,
              inputs, feature, aux_feat_batch, aux_output, aux_fc_batch_0, logits_aux_0,
              aux_fc_batch_1, logits_aux_1, inputs_loader,
